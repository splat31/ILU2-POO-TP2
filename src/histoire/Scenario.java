...
public class Scenario {
	...
	public static void main(String[] args) {
		...
		BoundaryEmmenager boundaryEmmenager = new BoundaryEmmenager(controlEmmenager);
		BoundaryAfficherVillage boundaryAfficherVillageois = new BoundaryAfficherVillage(controlAfficherVillage);

		BoundaryPrendreEtal boundaryChercherEtal = new BoundaryPrendreEtal(controlChercherEtal);
		BoundaryLibererEtal boundaryLibererEtal = new BoundaryLibererEtal(controlLibererEtal);
		...
		BoundaryLeVillage boundaryLeVillage = new BoundaryLeVillage(boundaryAfficherVillageois, boundaryEmmenager,
				boundaryChercherEtal, boundaryLibererEtal, boundaryAfficherMarche, boundaryAcheterProduit);
