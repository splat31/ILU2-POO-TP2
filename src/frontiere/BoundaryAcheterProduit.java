...
public class BoundaryAcheterProduit {
	...
	public void acheterProduit(String nomAcheteur) {
		...
		if (tab.length == 1 && tab[0] == "pas dans le village") {
			System.out.println("Je suis désolée " + nomAcheteur + " mais il faut etre un habitant de"
			...
			if (vendu == 0) {
				...
				System.out.println(nomAcheteur + " veut acheter " + demande + " " + produit + " mais "
						+ tab[indexvendeur] + " n'ens as plus que " + vendu + ". " + nomAcheteur
						+ " achète tout le stock de " + tab[indexvendeur]);
			} else {
